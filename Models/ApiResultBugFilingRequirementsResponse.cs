...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultBugFilingRequirementsResponse {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public BugFilingRequirementsResponse Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultBugFilingRequirementsResponse {\n");
