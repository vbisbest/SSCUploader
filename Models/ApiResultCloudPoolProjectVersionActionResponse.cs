...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultCloudPoolProjectVersionActionResponse {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public CloudPoolProjectVersionActionResponse Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultCloudPoolProjectVersionActionResponse {\n");
