...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultCloudPoolWorkerActionResponse {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public CloudPoolWorkerActionResponse Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultCloudPoolWorkerActionResponse {\n");
