...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultListBugfieldTemplateGroupDto {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public List<BugfieldTemplateGroupDto> Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultListBugfieldTemplateGroupDto {\n");
