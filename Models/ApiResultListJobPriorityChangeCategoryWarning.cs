...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultListJobPriorityChangeCategoryWarning {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public List<JobPriorityChangeCategoryWarning> Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultListJobPriorityChangeCategoryWarning {\n");
