...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultListPerformanceIndicatorHistory {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public List<PerformanceIndicatorHistory> Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultListPerformanceIndicatorHistory {\n");
