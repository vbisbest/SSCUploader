...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultListProjectVersionBugTracker {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public List<ProjectVersionBugTracker> Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultListProjectVersionBugTracker {\n");
