...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultListProjectVersionIssueDetails {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public List<ProjectVersionIssueDetails> Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultListProjectVersionIssueDetails {\n");
