...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultListProjectVersionIssueGroup {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public List<ProjectVersionIssueGroup> Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultListProjectVersionIssueGroup {\n");
