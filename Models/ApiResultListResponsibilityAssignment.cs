...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultListResponsibilityAssignment {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public List<ResponsibilityAssignment> Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultListResponsibilityAssignment {\n");
