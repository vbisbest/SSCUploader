...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultPasswordStrengthCheckResponse {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public PasswordStrengthCheckResponse Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultPasswordStrengthCheckResponse {\n");
