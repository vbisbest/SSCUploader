...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultProjectVersionRefreshResponse {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public ProjectVersionRefreshResponse Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultProjectVersionRefreshResponse {\n");
