...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ApiResultRefreshAuditAssistantPoliciesRequest {
    /// <summary>
    /// Gets or Sets Count
    /// </summary>
    ...
    public RefreshAuditAssistantPoliciesRequest Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ApiResultRefreshAuditAssistantPoliciesRequest {\n");
