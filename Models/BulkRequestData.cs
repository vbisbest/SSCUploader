...
namespace IO.Swagger.Model {
  ...
  public class BulkRequestData {
    ...
    /// </summary>
    /// <value>A list of bulk request items that represents requests that could have been issued independently (or use HATEOAS \"response\" scheme requests that map to individual requests).</value>
    [DataMember(Name="requests", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "requests")]
    public List<ApiBulkRequestItem> Requests { get; set; }
