...
namespace IO.Swagger.Model {
  ...
  /// <summary>
  /// Request to send the application version&#39;s data to Audit Assistant for assessment
  /// </summary>
  [DataContract]
  public class ProjectVersionAuditByAssistantRequest {
    ...
    /// </summary>
    /// <value>List containing single application version ID to send audit assistant</value>
